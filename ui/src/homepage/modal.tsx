import Login, { LoginHeader, LoginWarning } from "../auth/login";
import Options, { OptionsHeader } from "../options/menu";
...
export default function Modal(props: ModalProps) {
  return (
    <div
      className={"relative z-10" + (props.showModal ? "" : " hidden")}
          ...
          <div className="flex min-h-full justify-center p-4 text-center sm:items-center sm:p-0">
            <div className="relative transform overflow-hidden rounded-lg border-8 border-double border-amber-600 bg-orange-200 shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              <div className="text-center px-4 pb-4">
                ...
                {props.modalType === "Login" ? <LoginWarning /> : <></>}
                {props.modalType === "Login" ? (
                  <Login
